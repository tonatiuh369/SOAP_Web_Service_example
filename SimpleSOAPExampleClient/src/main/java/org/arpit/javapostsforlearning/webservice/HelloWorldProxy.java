...
public class HelloWorldProxy implements org.arpit.javapostsforlearning.webservice.HelloWorld {
  private String _endpoint = null;
  private org.arpit.javapostsforlearning.webservice.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new org.arpit.javapostsforlearning.webservice.HelloWorldServiceLocator()).getHelloWorld();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public org.arpit.javapostsforlearning.webservice.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
