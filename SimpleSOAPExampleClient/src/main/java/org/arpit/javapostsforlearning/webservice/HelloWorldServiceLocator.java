...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements org.arpit.javapostsforlearning.webservice.HelloWorldService {
    ...
    public org.arpit.javapostsforlearning.webservice.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public org.arpit.javapostsforlearning.webservice.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.arpit.javapostsforlearning.webservice.HelloWorldSoapBindingStub _stub = new org.arpit.javapostsforlearning.webservice.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.arpit.javapostsforlearning.webservice.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                org.arpit.javapostsforlearning.webservice.HelloWorldSoapBindingStub _stub = new org.arpit.javapostsforlearning.webservice.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.javapostsforlearning.arpit.org", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.javapostsforlearning.arpit.org", "HelloWorld"));
        }
