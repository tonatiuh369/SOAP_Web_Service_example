...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="org.arpit.javapostsforlearning.webservice.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        org.arpit.javapostsforlearning.webservice.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
